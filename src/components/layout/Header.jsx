  ...
  return (
    <header className="bg-white shadow-sm px-4 sm:px-6 py-4 flex items-center justify-between sticky top-0 z-10">
      ...
      <div className="flex items-center gap-2 sm:gap-4">
        ...
        <button onClick={() => location.reload()} title="Reload" className="w-8 h-8 rounded-full border border-gray-300 text-gray-500 hover:text-gray-700 hover:border-gray-400 flex items-center justify-center text-base transition flex-shrink-0">↺</button>
