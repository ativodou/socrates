          ...
          <div className="bg-white rounded-t-2xl sm:rounded-2xl w-full sm:max-w-lg max-h-[90vh] overflow-y-auto">
            ...
            <div className="p-5 space-y-5">
              ...
              <div className="bg-white border rounded-xl p-4 space-y-2">
                ...
                {publicSchool.directorPhone && <p className="text-sm text-gray-600">📞 Directeur: {publicSchool.directorPhone}</p>}
                {publicSchool.directorEmail && <p className="text-sm text-gray-600">✉️ Directeur: {publicSchool.directorEmail}</p>}
              </div>
              {/* Infos pratiques */}
